...
const CURRENT_LAYOUT_VERSION = 10; // Bump to force layout reset
  ...
  trading: {
    ...
    layout: {
      ...
      children: [
        ...
        { type: 'tabset', weight: 50, children: [{ type: 'tab', name: 'Price Chart', component: 'chart' }, { type: 'tab', name: 'Footprint', component: 'footprint' }] },
        { type: 'tabset', weight: 30, children: [{ type: 'tab', name: 'Order Book', component: 'orderbook', enableClose: false }, { type: 'tab', name: 'DOM Ladder', component: 'dom' }] },
      ],
    },
    borders: [],
  },
  ...
  useEffect(() => {
    try {
      ...
      if (savedLayout && savedVersion === String(CURRENT_LAYOUT_VERSION)) {
        ...
        setModel(Model.fromJson(parsedLayout));
      } else {
        // Reset to default and save new version
        console.log('[TapeFlowWorkspace] Layout version changed, resetting to default');
